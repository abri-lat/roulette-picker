...
export default function RouletteFood() {
        ...
        <div style={{ flex: "1 1 auto", display: "flex", minHeight: 0 }}>
          ...
          >
            ...
            >
              ...
              >
                <span style={{ color: "rgba(140,200,150,0.6)" }}>YA ELIGIERON</span>
            ...
            {available.length > 0 ? (
              ...
              >
                {total === 0
                  ...
                  : "> TODOS ELIGIERON · REINICIA LA RONDA"}
              </div>
            )}
          </main>
        </div>
      ...
      {winner && (
        ...
        >
          ...
          {allDone && (
            ...
            >
              // TODOS ELIGIERON — EL POOL SE REINICIARÁ
            </div>
          )}
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
            ...
            >
              {allDone ? "REINICIAR POOL" : "PASA A RECOGER TU COMIDA"}
            </button>
          </div>
          <div
            style={{
